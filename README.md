...
Dataset used for the project can be accessed [here]([https://example.com/dataset](https://github.com/sindhujasankararaman/Repeat-Customer-Rate-Analysis-using-Power-BI/blob/main/repeat_customer_rate_data.csv)).
